...
Active set, projected gradient, Frank–Wolfe, dual methods, barrier methods, primal-dual interior point.
...
The easiest way to compile and edit the source is via
